...
public class FunctionController extends BaseController {
	...
	@ApiImplicitParam(name = "id", value = "系统功能标识", required = true, dataType = "String", paramType = "query")
	...
	@ApiImplicitParam(name = "functionDTO", value = "系统功能对象", required = true, dataType = "FunctionDTO", paramType = "body")
	@ApiResponses(value = { @ApiResponse(code = 500, message = "服务端错误", response = Void.class) })
	...
	@ApiImplicitParam(name = "id", value = "系统功能标识(多个已逗号分隔)", required = true, dataType = "String", paramType = "query")
	@ApiResponses(value = { @ApiResponse(code = 500, message = "服务端错误", response = Void.class) })
	 ...
	 * @return 服务响应对象
	 */
	@ApiOperation(value = "批量保存系统功能", httpMethod = "POST", notes = "批量保存系统功能信息")
	@ApiResponses(value = { @ApiResponse(code = 500, message = "服务端错误", response = Void.class) })
	...
	@ApiImplicitParam(name = "id", value = "功能接口关系标识", required = true, dataType = "String", paramType = "query")
	@ApiResponses(value = { @ApiResponse(code = 500, message = "服务端错误", response = Void.class) })
	...
	@ApiImplicitParam(name = "functionApiRelDTO", value = "功能接口关系对象", required = true, dataType = "FunctionApiRelDTO", paramType = "body")
	@ApiResponses(value = { @ApiResponse(code = 500, message = "服务端错误", response = Void.class) })
	...
	@ApiImplicitParam(name = "id", value = "功能接口关系标识(多个已逗号分隔)", required = true, dataType = "String", paramType = "query")
	@ApiResponses(value = { @ApiResponse(code = 500, message = "服务端错误", response = Void.class) })
	 ...
	 * @return 服务响应对象
	 */
	@ApiOperation(value = "批量保存功能接口关系", httpMethod = "POST", notes = "批量保存功能接口关系信息")
	@ApiResponses(value = { @ApiResponse(code = 500, message = "服务端错误", response = Void.class) })
