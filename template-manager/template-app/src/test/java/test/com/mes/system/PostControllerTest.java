...
public class PostControllerTest extends BaseTester {
	...
	public void getPostById() throws Exception {
		RequestBuilder request = get("/post/getPostById").param("id", "1");
		String result = mvc.perform(request).andExpect(status().isOk()).andDo(print()).andReturn().getResponse().getContentAsString();
		logger.info("getPostById() process test with result:{}", result);
	}

	@Test
	public void getPostList() throws Exception {
		RequestBuilder request = get("/post/getPostList").param("id", "1");
		String result = mvc.perform(request).andExpect(status().isOk()).andDo(print()).andReturn().getResponse().getContentAsString();
		logger.info("getPostList() process test with result:{}", result);
	}
	...
	public void savePost() throws Exception {
		JSONObject jsonObject = new JSONObject();
						    				...
						    				RequestBuilder request = post("/post/savePost").contentType(MediaType.APPLICATION_JSON).content(jsonObject.toJSONString());
		String result = mvc.perform(request).andExpect(status().isOk()).andDo(print()).andReturn().getResponse().getContentAsString();
		logger.info("savePost() process test with result:{}", result);
	}
	...
	public void updatePost() throws Exception {
		...
		jsonObject.put("id", "1");
						    				...
						    				RequestBuilder request = post("/post/updatePost").contentType(MediaType.APPLICATION_JSON).content(jsonObject.toJSONString());
		String result = mvc.perform(request).andExpect(status().isOk()).andDo(print()).andReturn().getResponse().getContentAsString();
		logger.info("updatePost() process test with result:{}", result);
	}

	@Test
	public void deletePostById() throws Exception {
		RequestBuilder request = get("/post/deletePostById").param("id", "1");
		String result = mvc.perform(request).andExpect(status().isOk()).andDo(print()).andReturn().getResponse().getContentAsString();
		logger.info("deletePostById() process test with result:{}", result);
	}

	@Test
	public void batchSavePost() throws Exception {
		JSONArray jsonArray = new JSONArray();
		JSONObject jsonObject1 = new JSONObject();
																			jsonObject1.put("postTypeId","1");
		...
		RequestBuilder request = post("/post/batchSavePost").contentType(MediaType.APPLICATION_JSON).content(jsonArray.toJSONString());
		String result = mvc.perform(request).andExpect(status().isOk()).andDo(print()).andReturn().getResponse().getContentAsString();
		logger.info("batchSavePost() process test with result:{}", result);
	}
}
