...
public class AccessFilter extends ZuulFilter {
	...
	public Object run() {
		...
		String action = actonUrl;// 当前调用的方法
		Map<String, String> noFilterActionMap = new HashMap<String, String>();// todo
		if (noFilterActionMap.containsKey(action)) {// 如果当前是非过滤的的Action方法名则不作授权认证
			return null;
		} else {
			try {
				// 必填参数校验
				...
				// token在缓存中的信息
				Map<Object, Object> tokenMap = new HashMap<Object, Object>();// todo;
