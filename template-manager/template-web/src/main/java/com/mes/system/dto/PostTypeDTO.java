...
public class PostTypeDTO extends BaseDTO {
	...
	/**  岗位类型标识*/
	@ApiModelProperty(value = "岗位类型标识")
	private Long id;
	/**  岗位类型编号*/
	@ApiModelProperty(value = "岗位类型编号")
	private String code;
	/**  名称*/
	@ApiModelProperty(value = "名称")
	private String name;
	/**  类型(1一般类型,0部门缺省类型，2单位缺省类型)*/
	@ApiModelProperty(value = "类型(1一般类型,0部门缺省类型，2单位缺省类型)")
	private Long type;
	/**  岗位类型说明*/
	@ApiModelProperty(value = "岗位类型说明")
